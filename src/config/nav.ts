...
export const NAV: NavSection[] = [
  ...
  { title: 'Pipeline', expandable: true, items: [
    ...
    { label: 'Installs', path: '/installs', icon: '🔧' },
  ...
  { title: 'Operations', expandable: true, items: [
    ...
    { label: 'Service', path: '/service', icon: '🛠️' },
  ...
  { title: 'Reports', expandable: true, items: [
    ...
    { label: 'Machine Reports', path: '/reports/machines', icon: '🤖' },
    { label: 'Product Reports', path: '/reports/products', icon: '🍫' },
