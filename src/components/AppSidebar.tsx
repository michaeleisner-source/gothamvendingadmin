...
const NAV: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Enhanced Dashboard", to: "/enhanced-dashboard", icon: BarChart3 },
      { label: "Sales Dashboard", to: "/sales/dashboard", icon: TrendingUp },
      { label: "Prospect Dashboard", to: "/prospect-dashboard", icon: Users },
      { label: "Location Performance", to: "/location-performance", icon: MapPin },
      { label: "Driver Dashboard", to: "/driver", icon: Truck },
      { label: "Low Stock Alerts", to: "/alerts/low-stock", icon: AlertTriangle },
      { label: "Cash Flow", to: "/finance/cash-flow", icon: DollarSign },
    ],
  },
  {
    key: "sales",
