...
export default function ReviewSnapshot() {
  usePageSEO({
    title: "QA Review Snapshot - System Validation",
    description: "Comprehensive validation snapshot for QA testing and system verification"
  });
    ...
    <div className="container mx-auto p-6 space-y-4">
      <header className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <HelpTooltip content="Comprehensive validation of system components and data integrity for QA testing purposes." />
        </div>
        <button
          onClick={load}
          disabled={busy}
      ...
      <div className="rounded-xl border border-border bg-card p-4">
        <div className="font-medium mb-2 flex items-center gap-2">
          ...
          <HelpTooltip content="Financial metrics calculated from sales data over the past 14 days" />
        </div>
      ...
      <div className="text-xs text-muted-foreground">
        Tip: If any "Missing (ok if you skipped SQL)" tiles show red, run the SQL migration we shared earlier to enable those advanced checks.
      </div>
    </div>
  );
}
